...
define([
	 ...
	 *
	 * @param {Function} fn
	 * @param {{ usesElement: boolean }} properties
	 * @returns {Function}
	 */
	...
	Session.prototype = /** @lends module:leadfoot/Session# */ {
		 ...
		 * @returns {Promise.<module:leadfoot/Element>}
		 */
		getActiveElement: forCommand(function () {
			var self = this;
		 ...
		 * @returns {Promise.<void>}
		 */
		tap: forCommand(function (element) {
			if (element) {
				element = element.elementId;
			}
		 ...
		 * @returns {Promise.<void>}
		 */
		touchScroll: forCommand(function (element, xOffset, yOffset) {
			if (typeof yOffset === 'undefined' && typeof xOffset !== 'undefined') {
				yOffset = xOffset;
				xOffset = element;
				element = undefined;
		 ...
		 * @returns {Promise.<void>}
		 */
		doubleTap: forCommand(function (element) {
			if (element) {
				element = element.elementId;
			}
		 ...
		 * @returns {Promise.<void>}
		 */
		longTap: forCommand(function (element) {
			if (element) {
				element = element.elementId;
			}
		...
		flickFinger: forCommand(function (element, xOffset, yOffset, speed) {
